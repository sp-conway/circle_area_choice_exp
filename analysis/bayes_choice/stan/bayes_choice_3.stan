...
parameters {
  ...
  real b_w;
  real<lower=0.001> b_0_s_sigma;
  real<lower=0.001> b_w_s_sigma;
  real<lower=0.001> b_comp_s_sigma;
  real<lower=0.001> b_target_s_sigma;
  real<lower=0.001> b_distance_s_sigma;
  real<lower=0.001> b_targetcomp_distance_intxn_s_sigma;
...
model {
  ...
  b_targetcomp_distance_intxn_s_sigma~cauchy(0,2.5);
